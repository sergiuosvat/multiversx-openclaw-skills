...
OPENCLAW_REPO="multiversx/multiversx-openclaw-skills"
MOLTBOT_REPO="multiversx/moltbot-starter-kit"
BRANCH="main"
...
echo "  2. cp .env.example .env && edit your .env"
echo "  3. Create or import a wallet.pem file"
echo "  4. npm run register"
echo ""
